...
<div class="card">
	...
	<div class="card-body">
		<div id="main-dt-pending-invoices">
			<div class="text-center">
				<h4 class="card-title mt-3 mb-0 text-dark">
					<div class="spinner-grow text-light" role="status"></div> <?php echo lang('Text.loading'); ?>
				</h4>
...
<script>
	...
	function getPendingInvoicesDT() {
		$.ajax({
			type: "post",
			url: "<?php echo base_url('Dashboard/getPendingInvoicesDT'); ?>",
			dataType: "html",
			success: function(response) {
				$('#main-dt-pending-invoices').html(response);
			}
		});
	}
</script>