...
<div class="card">
	<div class="card-header">
		<div class="d-flex align-items-center">
			<h4 class="card-title mb-0"><?php echo lang('Text.dashboard_sent_invoices_title') ?></h4>
			<div class="ms-auto">
			</div>
		</div>
	</div>
	<div class="card-body">
		<div class="table-responsive overflow-hidden">
			<table id="dt-sent-invoices" class="table text-nowrap align-middle" style="width: 100%;">
				<thead>
					<tr>
				...
				<tbody>
					<?php foreach ($sentInvoices as $si) { ?>
						<tr>
							<td><?php echo $si->invoiceNumber; ?></td>
							<td><?php echo $si->customerName; ?></td>
							<td><?php echo date('d-m-Y', strtotime($si->added)); ?></td>
							<td class="text-end"><?php echo getMoneyFormat($config[0]->currency, $si->amount); ?></td>
							<td class="text-end">
								<a class="me-2 pay-invoice" href="#" data-invoice-id="<?php echo $si->invoiceID; ?>" title="<?php echo lang('Text.inv_set_paid'); ?>">
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bank" viewBox="0 0 16 16">
										<path d="m8 0 6.61 3h.89a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5H15v7a.5.5 0 0 1 .485.38l.5 2a.498.498 0 0 1-.485.62H.5a.498.498 0 0 1-.485-.62l.5-2A.5.5 0 0 1 1 13V6H.5a.5.5 0 0 1-.5-.5v-2A.5.5 0 0 1 .5 3h.89zM3.777 3h8.447L8 1zM2 6v7h1V6zm2 0v7h2.5V6zm3.5 0v7h1V6zm2 0v7H12V6zM13 6v7h1V6zm2-1V4H1v1zm-.39 9H1.39l-.25 1h13.72z" />
									</svg>
								</a>
								<a class="me-2 rectify-invoice" href="#" data-invoice-id="<?php echo $si->invoiceID; ?>" title="<?php echo lang('Text.inv_create_rec'); ?>">
...
<script>
	...
	var dtSentInvoices = $('#dt-sent-invoices').DataTable({ // DATA TABLE SENT INVOICES
		processing: false,
		serverSide: false,
		pageLength: 10,
		language: {
	...
	dtSentInvoices.on('click', '.pay-invoice', function(e) {
		e.preventDefault();
	...
	dtSentInvoices.on('click', '.rectify-invoice', function(e) {
		e.preventDefault();
		let invoiceID = $(this).attr('data-invoice-id');
