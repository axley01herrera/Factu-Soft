	...
	<div class="container mt-5">
		...
		<div class="row mt-2">
			<div class="col-6 text-center mb-2">
				<b><?php echo lang('Text.description'); ?></b>
			</div>
			<div class="col-6 text-center mb-2">
				<b><?php echo lang('Text.price');?></b>
			</div>
			<?php foreach ($items as $i) {
				$baseImponible = $baseImponible + $i->amount; ?>
				<div class="col-6 text-center mb-2">
					<?php echo 'x' . $i->quantity . ' ' . $i->description; ?>
				</div>
				<div class="col-6 text-center mb-2">
					<?php echo getMoneyFormat($config[0]->currency, $i->price); ?>
				</div>
			<?php } ?>
		</div>
		...
		<div class="row">
			...
			<?php foreach ($invoiceTax as $it) { ?>
				...
				<div class="<?php if (empty($it->taxPercent)) echo 'col-12';
							else echo 'col-6'; ?> text-center mb-2">
					<?php echo $it->taxDesc; ?>
				</div>
			...
			<div class="col-6 text-center mb-2">
				<b><?php echo getMoneyFormat($config[0]->currency, $total); ?></b>
			</div>
